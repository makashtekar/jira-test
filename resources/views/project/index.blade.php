<x-app-layout>
    <x-slot name="header">
        ...
        <div class="">
            ...
            <a class="text-blue-500 hover:text-blue-700 no-underline" href="{{route('project.create')}}" >Add New Project</a>
                        ...
                        @foreach($projects as $p)
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td>
                                    ...
                                    <span class="text-yellow-500" >In-Progress : {{ $p->inProgressTasks()->count()  }}</span>
                                    <span class="text-lime-800" >Done : {{ $p->doneTasks()->count()  }}</span>
                                </td>
                                <td class="px-6 py-4">

                                    <x-nav-link href="{{ route('task.create', $p->id)  }}">Add Task</x-nav-link>
